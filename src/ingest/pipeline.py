...
# Absolute imports (not `from ..`): Prefect loads this file BY PATH when running
# a flow, which has no package context — relative imports raise "beyond top-level
# package". Absolute `from src...` works because /app is on sys.path.
